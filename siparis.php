...
<td align=center colspan="5"> <font size=4 color=blue face='Cursive'> <b> ÇALIŞAN BİLGİ</b></td>
<br>
	<tr>
		<th bgcolor="#E6EE9C"><i>TC. No</th>
		<th bgcolor="#E6EE9C"><i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Ad Soyad&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
		<th bgcolor="#E6EE9C"><i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Telefon&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
		<th bgcolor="#E6EE9C"><i>Çalıştığı Şube</th>
	</tr>
<?php 
$baglanti=mysqli_connect("localhost","root","","kds");
$baglanti->set_charset("utf8");
$sql="SELECT calisan.calisan_tc,calisan.calisan_ad,calisan_soyad, calisan.calisan_tel, sube.sube_ad
FROM calisan, sube
WHERE calisan.sube_id = sube.sube_id";
$sorgu=mysqli_query($baglanti,$sql);
$a="TL";
while( $sonuc=mysqli_fetch_array($sorgu,MYSQLI_ASSOC) ){
	echo '<tr>';
	echo "<td align='center' bgcolor=#C5CAE9>"."<font face='Cursive'>".$sonuc["calisan_tc"]."</td>";
